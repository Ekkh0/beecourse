        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="card header-card">
                    <div class="card-body">
                        <h2 class="card-title">Introduction to AI, Machine Learning and Python basics</h2>
                        <p class="card-text">Learn to understand Artificial Intelligence and Machine Learning algorithms, and
                            learn the basics of Python Programming</p>
